...
export interface ICoreUpdate extends ISiteUpdate {
    name: string;
    existingVersion: string;
    recommendedVersion: string;
    status: string;
...
export interface IModuleUpdate extends ISiteUpdate {
    name: string;
    slug: string;
    existingVersion: string;
    status: string;
...
export interface IThemeUpdate extends ISiteUpdate {
    name: string;
    slug: string;
    existingVersion: string;
    status: string;
